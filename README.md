...
- Проверяет новых или неизвестных пользователей в модерируемых чатах: на вступление, первое сообщение и первую реакцию.
...
- Первая реакция от незарегистрированного пользователя запускает challenge; если пользователь не ответит, бот банит его.
